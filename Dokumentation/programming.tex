...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.5\textwidth]{pic/web-server.png}%
...
[KAMIL BESCHREIBT HIER WIE DER web server ZU STARTEN IST UND ERGAENZT AUCH DAS GITHUB-HELPDINGSDA - Alles klar]
