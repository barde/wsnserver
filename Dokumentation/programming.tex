...
Furthermore the \textit{Setup.py} allows the cleaning of the tables by using the \textit{--rmDev},  \textit{--rmData} and \textit{--rmCMD}.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pic/Setuppy.png}%
...
class can decide which kind of database connection it will return the calling method as response.
